...
<description>A guide to show how to post stats to the NBList API, in lots of popular programming languages.</description>
<url>post-stats</url>

# Post Stats
Here are examples of posting bot stats to the NBList API.
...
or go to: `https://nblist.glitch.me/dashboard/bots/[yourBotId]/api`
...
fetch(`https://nblist.glitch.me/api/v1/bots/${botId}/stats`, {
